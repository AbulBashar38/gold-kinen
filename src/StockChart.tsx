...
import { Chart as ChartJS, CategoryScale, LinearScale, PointElement, LineElement, Filler, Tooltip, ChartOptions } from 'chart.js';
  ...
  switch (range) {
    ...
    case '1M': {
      for (let i = 0; i < 30; i++) {
        ...
        data.push({
          date: i % 5 === 0 ? d.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }) : '',
          price: Number(basePrice.toFixed(2))
        });
      }
      break;
    ...
    case '6M': {
      ...
      for (let i = 5; i >= 0; i--) {
        ...
        months.push(d.toLocaleDateString('en-US', { month: 'short', day: 'numeric' }));
      }
    ...
    case 'YTD': {
      ...
      for (let i = 0; i < daysSinceStart; i++) {
        ...
        data.push({
          date: i % (pointsPerMonth || 1) === 0 && monthIndex < months.length ? months[monthIndex] : '',
          price: Number(basePrice.toFixed(2))
        });
      }
      break;
    ...
    datasets: [
      {
        ...
        backgroundColor: (context: any) => {
          ...
          gradient.addColorStop(0, 'rgba(72, 69, 210, 0.3)');
          gradient.addColorStop(1, 'rgba(72, 69, 210, 0.05)');
          return gradient;
        },
        fill: true,
        tension: 0.4,
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Closed: 29 Oct, 7:59 pm GMT-4
            </p>
          </div>

          <div className="text-right">
            <p className="text-2xl text-gray-500 tracking-wide">
              NASDAQ: <span className="text-gray-400">AMZN</span>
            </p>
          </div>
        </div>
