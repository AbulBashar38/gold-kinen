...
const OnlyCalculatorBangla = () => {
  ...
  return (
    <main
      className={`w-full h-full bg-transparent p-2 font-hind ${
        transparent
          ? "bg-transparent"
    ...
    >
      ...
      <div className="flex flex-col  items-end gap-3 sm:gap-8 mb-4  ">
        <div className="flex-1 w-full">
          ...
          <input
            type="text"
            value={convertToBanglaNumerals(quantity)}
            onChange={(e) => {
            ...
            placeholder={`${
              activeTab === "bhori" ? "ভরি লিখুন" : "গ্রাম লিখুন"
            }`}
          />
        </div>
        ...
        <div className="flex-1 w-full">
          ...
          <input
            type="text"
            value={convertToBanglaNumerals(price)}
            onChange={(e) => {
              const value = e.target.value;
              if (value === "" || /^[০-৯\d]*\.?[০-৯\d]*$/.test(value)) {
...
export default OnlyCalculatorBangla;
