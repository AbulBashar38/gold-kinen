...
const OnlyCalculator = () => {
  ...
  return (
    <main className="w-full min-h-screen bg-transparent p-4 sm:p-6 md:p-8">
      <div className="w-full max-w-2xl sm:max-w-3xl md:max-w-4xl mx-auto">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-6 sm:mb-8 text-yellow-700">
          Price Calculator
        </h1>
