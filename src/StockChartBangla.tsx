...
export default function StockChartBangla() {
    ...
    switch (range) {
      ...
      case "6Years": {
        ...
        data.sixYearData.forEach((item) => {
          result.push({
            date: convertToBanglaNumerals(item.year),
            price: item.price,
          });
        });
        break;
      ...
      tooltip: {
        ...
        callbacks: {
          ...
          label: function (context) {
            return "৳ " + formatBanglaNumber(context.parsed.y);
          },
        },
      },
    },
      ...
      y: {
        ...
        ticks: {
          ...
          callback: function (value) {
            return "৳ " + formatBanglaNumber(value as number);
          },
        },
      },
    },
  ...
  return (
    <div
      className={`box-border w-full h-full font-hind ${
        transparent
          ? "bg-transparent"
          : "bg-gradient-to-br from-[#4786FF] to-[#2B5099]"
      }`}
